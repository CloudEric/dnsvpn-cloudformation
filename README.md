...
This project is designed for AWS. Other cloud platforms have various advantages but AWS was the most relevant to my work and expertise. I’m leveraging the following AWS services:
...
<a href="https://www.docker.com/"><img src="./images/docker.png" width="120"></a>

The key components of the software stack are containerized for ease of management.

<a href="https://pi-hole.net/"><img src="./images/pi-hole.png" width="120"></a>
<a href="https://openvpn.net/"><img src="./images/openvpn.png" width="120"></a>
...
- If you receive a TLS error then it's probably an issue with the route on your local network. If the DNS isn't resolving then it's probably and issue with the route to your DNS server. You can view your route configuration in `/mnt/dockershare/ovpn-data/openvpn.conf`.
---
...
- Add the Watchtower docker container for automatic updates of the containers. This isn’t stricly nessecary because you can just redeploy the CloudFormation stack but it should be easy to integrate.
...
- [v2tec/watchtower](https://github.com/v2tec/watchtower) (pending)
